...
const SliderCard = () => {
  return (
    <div className="w-screen text-white flex text-sm items-center justify-center mb-20 pr-32 ">
      <div className="w-[70%] max-w-[800px] flex flex-col items-center justify-center text-center gap-6">
